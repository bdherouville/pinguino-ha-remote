...
1. Put the **emulator** in pairing mode (hold **MODE** ~10 s until its LED blinks — it
   advertises as `Ganymede`).
2. Put the **AC** in pairing mode (hold **MODE** ~10 s; its display dot blinks rapidly).
